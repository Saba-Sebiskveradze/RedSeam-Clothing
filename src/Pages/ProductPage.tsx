...
const blurStyle = isCartOpen
  ...
  const handleImageClick = (imgUrl: string, index: number) => {
    ...
    if (
      ...
      product.available_colors[index]
    ) {
          ...
          <div className="flex justify-between items-start mb-[100px]">
            ...
            <div className="flex flex-col gap-[56px] w-[704px]">
              ...
              <div className="flex flex-col gap-[48px]">
                ...
                {/* Cart */}
                <div 
                  className={`flex justify-center items-center gap-[10px] py-[16px] rounded-[10px] transition-opacity ${
                    addingToCart ? 'bg-gray-400 cursor-not-allowed' : 'bg-Red cursor-pointer hover:bg-red-600'
                  }`}
                  onClick={addingToCart ? undefined : handleAddToCart}
                >
                  <img
                    src={shopingCart}
                    alt="shopping cart"
                ...
                {addToCartError && (
                  <div className="text-Red poppins-font font-[400] text-[14px] text-center">
                    {addToCartError}
                  </div>
                )}
